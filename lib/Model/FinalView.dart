...
//                                    validator: (value) {
//                             RegExp numericRegex = new RegExp(r'^.{6,}$');
//                             RegExp symRegex=new RegExp(r'[!@#$%^&*()]');
//                             RegExp hasUpperCase=new RegExp(r'[A-Z]');
//                             RegExp hasLowerCase=new RegExp(r'[a-z]');
//                             if (value!.isEmpty) {
//                               return "This field is required";
//                             }
//                             if (!numericRegex.hasMatch(value)&&symRegex.hasMatch(value)&&hasUpperCase.hasMatch(value)&&hasLowerCase.hasMatch(value)) {
...
//         hintText: "Password",
//         hintStyle: const TextStyle(fontFamily: kFontFamily,color: Colors.black),
//         contentPadding:
